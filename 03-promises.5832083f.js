...
var r=i("6JpON");// adaugare handler pt evenimentul DOMContentLoaded, care este declansat
...
let i=Math.random()>.3;setTimeout(()=>{i?n({position:e,delay:t}):o({position:e,delay:t})},t)})})(n,l).then(({position:t,delay:n})=>{/*@__PURE__*/e(r).Notify.success(`\u{2705} Fulfilled promise ${t} in ${n}ms`)}).catch(({position:t,delay:n})=>{/*@__PURE__*/e(r).Notify.failure(`\u{274C} Rejected promise ${t} in ${n}ms`)})}})})}();//# sourceMappingURL=03-promises.5832083f.js.map
